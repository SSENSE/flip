...
var stylis = createCommonjsModule(function (module, exports) {
  ...
  */
	(function (factory) {
		if ((typeof exports === 'undefined' ? 'undefined' : _typeof$1(exports)) === 'object' && typeof module !== 'undefined') {
   ...
   */
		function stylis(selector, styles, animations, compact, middlewares) {
			...
			if (uses === true) {
				has = (typeof middleware === 'undefined' ? 'undefined' : _typeof$1(middleware)).charCodeAt(0);
...
var _styledComponent = (function (ComponentStyle) {
  var createStyledComponent = function createStyledComponent(target, rules, props) {
    var prevProps = target && typeof target !== 'string' ? (typeof target === 'undefined' ? 'undefined' : _typeof$1(target)) === 'object' ? target.props : typeof target === 'function' ? target.options.props : {} : {};
